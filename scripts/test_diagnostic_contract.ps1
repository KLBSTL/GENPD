...
Require-Text (Join-Path $projectRoot 'source\main.cpp') '--profile-line-search-decisions'
...
Require-Text (Join-Path $projectRoot 'source\simulation.cpp') 'gradient_norm_sampled'
Require-Text (Join-Path $projectRoot 'source\simulation.cpp') 'armijo_rejections'
