...
if ($manifest.protocol_version -ne 4 -or $manifest.quality_target.position_rel_l2_p95 -ne 0.001 -or $manifest.performance.repetitions -ne 3 `
...
if ($manifest.variants -notcontains 'gpu-xpbd-jacobi' -or $manifest.quality_target.xpbd.p95_max_stretch_strain_reference_ratio -ne 1.1 `
    -or $manifest.quality_target.xpbd.p95_mean_stretch_strain -ne 0.02 `
    -or $manifest.quality_target.xpbd.quality_sampling -ne 'reference-checkpoint-frames') {
